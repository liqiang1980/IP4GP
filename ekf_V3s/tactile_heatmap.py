...
def plot_once(tacperception):
    _dataClass = tacperception
    fig = plt.figure(figsize=(20, 5))
    plt.subplot(141)
    plt.title("rf", fontsize=25)
    sns.heatmap(_dataClass.tacdata_rf, vmin=0, vmax=10, cbar=False, cbar_kws={},
                cmap="Greens", annot=False,
                annot_kws={"fontsize": 12}, fmt='g', yticklabels=False, xticklabels=False, linewidths=.5)
    plt.subplot(142)
    plt.title("mf", fontsize=25)
    sns.heatmap(_dataClass.tacdata_mf, vmin=0, vmax=10, cbar=False, cbar_kws={},
                cmap="Greens", annot=False,
                annot_kws={"fontsize": 12}, fmt='g', yticklabels=False, xticklabels=False, linewidths=.5)
    plt.subplot(143)
    plt.title("ff", fontsize=25)
    sns.heatmap(_dataClass.tacdata_ff, vmin=0, vmax=10, cbar=False, cbar_kws={},
                cmap="Greens", annot=False,
                annot_kws={"fontsize": 12}, fmt='g', yticklabels=False, xticklabels=False, linewidths=.5)
    plt.subplot(144)
    plt.title("th", fontsize=25)
    sns.heatmap(_dataClass.tacdata_th, vmin=0, vmax=10, cbar=False, cbar_kws={},
                cmap="Greens", annot=False,
                annot_kws={"fontsize": 12}, fmt='g', yticklabels=False, xticklabels=False, linewidths=.5)
    plt.show()
