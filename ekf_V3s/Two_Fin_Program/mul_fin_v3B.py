...
Af_xyz = np.load("save_data/WithoutInitE/save_f/save_pose_y_t_xyz.npy")
Af_rpy = np.load("save_data/WithoutInitE/save_f/save_pose_y_t_rpy.npy")
Ai_xyz = np.load("save_data/WithoutInitE/save_i/save_pose_y_t_xyz.npy")
Ai_rpy = np.load("save_data/WithoutInitE/save_i/save_pose_y_t_rpy.npy")
Afx = Af_xyz[1:, 0] * 1000
Afy = Af_xyz[1:, 1] * 1000
Afz = Af_xyz[1:, 2] * 1000
...
fEKF_all = np.load("save_data/fEKF_incremental.npy")
iEKF_all = np.load("save_data/iEKF_incremental.npy")
